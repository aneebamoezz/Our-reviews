<div class="no-results not-found">
	<?php $whats_post_type = (isset($its_question) && (wpqa_questions_type == $its_question || wpqa_asked_questions_type == $its_question)?esc_html__('Questions','discy'):esc_html__('Posts','discy'));
	if (has_wpqa()) {
