...
if ($related_query->have_posts()) {?>
	<div class="related-post<?php echo (is_singular(wpqa_questions_type) || is_singular(wpqa_asked_questions_type) || $related_style == "links"?" related-post-links":"").(is_singular(wpqa_questions_type) || is_singular(wpqa_asked_questions_type)?" related-questions":"")?>">
